...
No SQL Server Management Studio (SSMS), execute o seguinte script:
...
Verifique se a variável API_URL no arquivo script.js corresponde à porta que o seu backend está rodando (ex: https://localhost:7000).
